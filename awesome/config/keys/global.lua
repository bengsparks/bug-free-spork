...
local globalKeys = awful.util.table.join(
  ...
  awful.key(
		{modkey},
		"v",
		function() awful.util.spawn("/home/benji/.config/dmenu/nord-countries.sh") end,
  ...
  awful.key(
		{modkey},
		"p",
		function() awful.util.spawn("/home/benji/.config/dmenu/projectFoldersRofi.sh") end,
  ...
  awful.key(
		{modkey, "Shift"},
		"r",
		function() awful.spawn.with_shell('rofi -no-lazy-grab -show drun -theme /home/benji/.config/rofi/centered.rasi') end,
