...
local bar = function(s)
	...
	function bar_toggle()
		...
		awful.screen.connect_for_each_screen(function(s)
			...
			awful.spawn.with_shell('echo true > /home/benji/.config/awesome/widget/control-center/bar-button/bar-status ')
		elseif s.panel.visible == true then
		awful.screen.connect_for_each_screen(function(s)
			s.panel.visible = false
		end)
			awful.spawn.with_shell('echo false > /home/benji/.config/awesome/widget/control-center/bar-button/bar-status ')
		end
	end
