...
local exit_screen = function(s)
    ...
    function exit_screen_show()
        awful.screen.connect_for_each_screen(
            function(s) s.exit_screen_unfocused.visible = true end)
    ...
    s.exit_screen:buttons(gears.table.join( -- Middle click - Hide exit_screen
    ...
    s.exit_screen_unfocused:setup{nil, layout = wibox.layout.align.horizontal}
